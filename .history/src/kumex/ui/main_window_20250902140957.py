...
class MainWindow(tk.Frame):
    ...
    def _open_stock_dialog(self):
        ...
        .grid(row=0, column=6, padx=(0, 8), pady=6, sticky="w")
        ttk.Radiobutton(op_box, text="– Списание",   variable=self._op_type, value="sub")\
        .grid(row=0, column=7, padx=(0, 8), pady=6, sticky="w")

        # Кнопка сразу в первой строке, справа
        ttk.Button(op_box, text="Добавить операцию", command=self._add_stock_operation)\
        .grid(row=0, column=8, padx=8, pady=6, sticky="e")
